...
public final class ReflectionUtils {
    ...
    /**
     * Represents an enumeration of Java dk.bondegaard.data types with corresponding classes
     * <p>
     * This class is part of the <b>ReflectionUtils</b> and follows the same usage conditions
     *
     * @author DarkBlade12
    ...
    public enum DataType {
        ...
        /**
         * Construct a new dk.bondegaard.data type
         *
         * @param primitive Primitive class of this dk.bondegaard.data type
         * @param reference Reference class of this dk.bondegaard.data type
         */
        ...
        /**
         * Returns the dk.bondegaard.data type with the given primitive/reference class
         *
         * @param clazz Primitive/Reference class of the dk.bondegaard.data type
         * @return The dk.bondegaard.data type
         */
        ...
        /**
         * Returns the primitive class of the dk.bondegaard.data type with the given reference class
         *
         * @param clazz Reference class of the dk.bondegaard.data type
        ...
        /**
         * Returns the reference class of the dk.bondegaard.data type with the given primitive class
         *
         * @param clazz Primitive class of the dk.bondegaard.data type
        ...
        /**
         * Returns the primitive class of this dk.bondegaard.data type
         *
         * @return The primitive class
         */
        ...
        /**
         * Returns the reference class of this dk.bondegaard.data type
         *
         * @return The reference class
         */
