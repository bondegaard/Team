...
public enum ParticleEffect {
    ...
    /**
     * Determine if the dk.bondegaard.data type for a particle effect is correct
     *
     * @param effect Particle effect
     * @param data   Particle dk.bondegaard.data
     * @return Whether the dk.bondegaard.data type is correct or not
     */
     ...
     * @throws ParticleDataException    If the particle effect requires additional dk.bondegaard.data
    ...
    public void display(float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, double range) throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
        ...
        if (hasProperty(ParticleProperty.REQUIRES_DATA)) {
            throw new ParticleDataException("This particle effect requires additional dk.bondegaard.data");
        }
    ...
    /**
     * Displays a particle effect which requires additional dk.bondegaard.data and is only visible for all players within a certain range in the world of @param center
     *
     ...
     * @param range   Range of the visibility
     * @throws ParticleVersionException If the particle effect is not supported by the server version
     * @throws ParticleDataException    If the particle effect does not require additional dk.bondegaard.data or if the dk.bondegaard.data type is incorrect
     * @see ParticlePacket
     * @see ParticlePacket#sendTo(Location, double)
     */
    public void display(ParticleData data, float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, double range) throws ParticleVersionException, ParticleDataException {
        ...
        if (!hasProperty(ParticleProperty.REQUIRES_DATA)) {
            throw new ParticleDataException("This particle effect does not require additional dk.bondegaard.data");
        }
        if (!isDataCorrect(this, data)) {
            throw new ParticleDataException("The particle dk.bondegaard.data type is incorrect");
        }
        new ParticlePacket(this, offsetX, offsetY, offsetZ, speed, amount, range > 256, data).sendTo(center, range);
    }

    /**
     * Displays a particle effect which requires additional dk.bondegaard.data and is only visible for the specified players
     *
     * @param data    Data of the effect
     * @param offsetX Maximum distance particles can fly away from the center on the x-axis
     * @param offsetY Maximum distance particles can fly away from the center on the y-axis
    ...
    /**
     * Displays a single particle which requires additional dk.bondegaard.data that flies into a determined direction and is only visible for all players within a certain range in the world of @param center
     *
     * @param data      Data of the effect
     * @param direction Direction of the particle
     * @param speed     Display speed of the particles
    ...
    /**
     * Displays a single particle which requires additional dk.bondegaard.data that flies into a determined direction and is only visible for the specified players
     *
     * @param data      Data of the effect
     * @param direction Direction of the particle
     * @param speed     Display speed of the particles
    ...
    public enum ParticleProperty {
        ...
        REQUIRES_WATER,
        /**
         * The particle effect requires block or item dk.bondegaard.data to be displayed
         */
        REQUIRES_DATA,
        /**
    ...
    /**
     * Represents the particle dk.bondegaard.data for effects like {@link ParticleEffect#ITEM_CRACK}, {@link ParticleEffect#BLOCK_CRACK} and {@link ParticleEffect#BLOCK_DUST}
     * <p>
     * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
    ...
    public static abstract class ParticleData {
        ...
        /**
         * Construct a new particle dk.bondegaard.data
         *
        ...
        /**
         * Returns the material of this dk.bondegaard.data
         *
         * @return The material
         */
        ...
        /**
         * Returns the dk.bondegaard.data value of this dk.bondegaard.data
         *
         * @return The dk.bondegaard.data value
         */
        public byte getData() {
            return data;
        }
        ...
        /**
         * Returns the dk.bondegaard.data as an int array for packet construction
         *
         * @return The dk.bondegaard.data for the packet
         */
        ...
        /**
         * Returns the dk.bondegaard.data as a string for pre 1.8 versions
         *
         * @return The dk.bondegaard.data string for the packet
         */
    ...
    /**
     * Represents the item dk.bondegaard.data for the {@link ParticleEffect#ITEM_CRACK} effect
     * <p>
     * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
    ...
    public static final class ItemData extends ParticleData {
        /**
         * Construct a new item dk.bondegaard.data
         *
    ...
    /**
     * Represents the block dk.bondegaard.data for the {@link ParticleEffect#BLOCK_CRACK} and {@link ParticleEffect#BLOCK_DUST} effects
     * <p>
     * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
    ...
    public static final class BlockData extends ParticleData {
        /**
         * Construct a new block dk.bondegaard.data
         *
    ...
    /**
     * Represents a runtime exception that is thrown either if the displayed particle effect requires dk.bondegaard.data and has none or vice-versa or if the dk.bondegaard.data type is incorrect
     * <p>
     * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
    ...
    private static final class ParticleDataException extends RuntimeException {
        ...
        /**
         * Construct a new particle dk.bondegaard.data exception
         *
